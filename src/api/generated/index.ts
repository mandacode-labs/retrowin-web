...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetSystemQueryKey(systemId);
   ...
   return  { queryKey, queryFn, enabled: systemId !== null && systemId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSystem>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const deleteSystem = async (systemId: string, options?: RequestInit): Promise<deleteSystemResponse> => {
  ...
  const data: deleteSystemResponse['data'] = body ? JSON.parse(body) : undefined
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListSystemUsersQueryKey(systemId);
   ...
   return  { queryKey, queryFn, enabled: systemId !== null && systemId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listSystemUsers>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetSystemUserQueryKey(systemId,uid);
   ...
   return  { queryKey, queryFn, enabled: systemId !== null && systemId !== undefined && uid !== null && uid !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSystemUser>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const deleteSystemUser = async (systemId: string,
  ...
  const data: deleteSystemUserResponse['data'] = body ? JSON.parse(body) : undefined
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListSystemGroupsQueryKey(systemId);
   ...
   return  { queryKey, queryFn, enabled: systemId !== null && systemId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listSystemGroups>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetSystemGroupQueryKey(systemId,gid);
   ...
   return  { queryKey, queryFn, enabled: systemId !== null && systemId !== undefined && gid !== null && gid !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSystemGroup>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const deleteSystemGroup = async (systemId: string,
  ...
  const data: deleteSystemGroupResponse['data'] = body ? JSON.parse(body) : undefined
...
export const addGroupMember = async (systemId: string,
  ...
  const data: addGroupMemberResponse['data'] = body ? JSON.parse(body) : undefined
...
export const removeGroupMember = async (systemId: string,
  ...
  const data: removeGroupMemberResponse['data'] = body ? JSON.parse(body) : undefined
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetRootDirectoryQueryKey(systemId);
   ...
   return  { queryKey, queryFn, enabled: systemId !== null && systemId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getRootDirectory>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getStatPathQueryKey(systemId,params);
   ...
   return  { queryKey, queryFn, enabled: systemId !== null && systemId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof statPath>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getLsQueryKey(systemId,params);
   ...
   return  { queryKey, queryFn, enabled: systemId !== null && systemId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof ls>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export const unlink = async (systemId: string,
  ...
  const data: unlinkResponse['data'] = body ? JSON.parse(body) : undefined
...
const {query: queryOptions, fetch: fetchOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDownloadUrlQueryKey(systemId,params);
   ...
   return  { queryKey, queryFn, enabled: systemId !== null && systemId !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getDownloadUrl>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
