...
>(
  ...
  return {
    queryKey,
    queryFn,
    enabled: systemId !== null && systemId !== undefined,
    ...queryOptions,
...
export const deleteSystem = async (
  ...
  const data: deleteSystemResponse["data"] = body
    ? JSON.parse(body)
    : undefined;
  return {
    data,
...
export const deleteSystemUser = async (
  ...
  const data: deleteSystemUserResponse["data"] = body
    ? JSON.parse(body)
    : undefined;
  return {
    data,
...
export const deleteSystemGroup = async (
  ...
  const data: deleteSystemGroupResponse["data"] = body
    ? JSON.parse(body)
    : undefined;
  return {
    data,
...
export const addGroupMember = async (
  ...
  const data: addGroupMemberResponse["data"] = body
    ? JSON.parse(body)
    : undefined;
  return {
    data,
...
export const removeGroupMember = async (
  ...
  const data: removeGroupMemberResponse["data"] = body
    ? JSON.parse(body)
    : undefined;
  return {
    data,
